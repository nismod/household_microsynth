...
class Test(TestCase):
  ...
  def test_hh1(self):
    ...
    self.assertTrue(Utils.check_hh(microsynth, num_occ_dwellings, num_dwellings, num_communal, pop_occupied_lb, pop_communal))
  ...
  def test_sc1(self):
    ...
    self.assertTrue(Utils.check_hh(microsynth, num_occ_dwellings, num_dwellings, num_communal, pop_occupied_lb, pop_communal, scotland=True))
