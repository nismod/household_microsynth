...
def do_hh(region, resolution):
    ...
    if sum(msynth.lc4605.OBS_VALUE) != total_occ_dwellings:
        ...
        print("Count mismatch in table LC4605 (" + str(
            lc4605_hrps) + ") will be adjusted. (Likely missing HRPs aged under 16)")
    ...
    success = Utils.check_hh(msynth, total_occ_dwellings, total_households, total_communal, occ_pop_lbound,
                             communal_pop, msynth.scotland)
    if success:
        print("ok")
    else:
        print("failed")
...
if __name__ == "__main__":
    ...
    parser.add_argument("region", type=str,
                        help="the ONS code of the local authority district (LAD) to be covered by the microsynthesis, e.g. E09000001")
    parser.add_argument("resolution", type=str,
                        help="the geographical resolution of the microsynthesis (e.g. OA11, LSOA11, MSOA11)")
    ...
    parser.add_argument("--do-hrp", action='store_const', const=True, default=False,
                        help="do household ref person generation")
